<template>
  <article class="container descr-section">
      <div class="row">
          <div class="descr-section__img offset-xl-1 col-xl-5 col-md-6 col-10 offset-1 offset-md-0">
          ...
          <div class="descr-section__content offset-xl-7 col-xl-4 col-md-6 col-12">
              <div class="logo"><b>Time</b>Keeper</div>
              <h2>Описание раздела</h2>
              <p class="text-16">
                  Учитывая ключевые сценарии поведения, повышение уровня гражданского сознания требует от нас анализа системы массового участия. Учитывая ключевые сценарии поведения, повышение уровня гражданского сознания требует
                  от нас анализа системы массового участия. Учитывая ключевые сценарии поведения, повышение уровня гражданского сознания требует от нас анализа системы массового участия.
              </p>
              <small>TimeKeeper 2022/ Все права защищены</small>
          </div>
      </div>
    </article>
</template>
